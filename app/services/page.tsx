      ...
      <section className="bg-[#231F20] px-6 py-24 sm:px-10 md:px-16 md:py-32 lg:px-24">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <div className="mt-20 grid border-t border-white/10 sm:grid-cols-2 lg:grid-cols-5">
              <ProcessItem
                number="01"
                title="Discover"
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-14 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            ...
            >
              ...
              <div className="mt-12 border-t border-[#231F20]/15">
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <span className="h-px w-8 bg-[#231F20]/15 transition-all duration-500 group-hover:w-14 group-hover:bg-[#231F20]/40" />
      </div>
