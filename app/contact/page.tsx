...
// ─────────────────────────────────────────────────────────────────────────────
// Studio info — pulled from env, with fallbacks so the page never
// renders blank fields if a variable is missing at build time
// ─────────────────────────────────────────────────────────────────────────────

const SITE = {
  name: process.env.NEXT_PUBLIC_SITE_NAME || "ASANG Design Studio",
};
...
// ─────────────────────────────────────────────────────────────────────────────
// Social links — filters out anything left blank in env (e.g. Pinterest)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Icons — hand-drawn to match the line-weight of the rest of the site
// rather than pulling in a brand-icon package
// ─────────────────────────────────────────────────────────────────────────────
...
// A floating-label text input driven purely by CSS (:placeholder-shown),
// so it stays in sync with the value stored in formData with no extra state.
function FloatingField({
  ...
  return (
    <div className="relative">
      ...
      {/* underline that draws in on focus, on top of the static border */}
      <span
        className="
          pointer-events-none
...
export default function ContactUs() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setStatus("error");
      setStatusMessage("Unable to submit right now. Please try again, or reach us directly.");
    }
  };
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-2 lg:gap-24">
          ...
          >
            {/* Studio address */}
            <div>
              <h3 className="mb-4 flex items-center gap-2 font-[family-name:var(--font-montserrat)] text-xs font-semibold uppercase tracking-[0.3em] text-[#8F9A9B]">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 font-[family-name:var(--font-cormorant)] text-2xl text-[#231F20]">
                <div className="flex items-center">
                  <a
                    href={`mailto:${CONTACT.email}`}
                    className="inline-flex items-center gap-3 transition-colors hover:text-[#8F9A9B]"
                  >
                    <Icon name="mail" className="h-4 w-4 shrink-0 text-[#8F9A9B]" />
                    {CONTACT.email}
                  </a>
                ...
                >
                  ...
                  <span className="font-[family-name:var(--font-montserrat)] text-[11px] font-semibold uppercase tracking-[0.2em] text-[#8F9A9B]">
                    WhatsApp
                  </span>
                </a>
              </div>
