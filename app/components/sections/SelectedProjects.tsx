...
// Demo data for projects covering all verticals
const projectsData = [
  {
    id: 1,
    ...
    <section className="bg-white px-8 py-24 text-gray-900 md:px-24">
      ...
      >
        ...
        >
          ...
          <p className="pr-4 text-sm leading-relaxed text-gray-500">
            Innovative architectural solutions spanning commercial hubs, 
            residential living spaces, and large-scale industrial facilities.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="pr-4 text-sm leading-relaxed text-gray-500">
            Curated materials and bespoke interior design for commercial offices, 
            residential homes, and industrial workspaces.
          </p>
        </motion.div>
