...
//   { number: "06", file: "image6.jpg", title: "Master Bedroom" },
...
//     label: "Commercial",
//     description:
//       "Spaces built for commerce — designed to command presence and inspire confidence.",
...
//     label: "Luxury",
//     description:
//       "Residences where material precision and spatial calm define everyday luxury.",
//     folder: `${BASE}/Luxury`,
//     count: 15,
...
//     label: "Penthouse",
//     description:
//       "Sky-level living — open volumes, curated views, and refined detail.",
...
//     description:
//       "Thoughtful short-stay environments — compact, complete, considered.",
...
//         <div className="mx-auto flex w-full max-w-7xl flex-col md:flex-row md:items-end md:justify-between">
...
//     <section
//       ref={containerRef}
//       className="relative h-[400vh] bg-[#0E0E0E]"
//     >
...
//                 <h2 className="font-[family-name:var(--font-cormorant)] text-[10vw] font-medium leading-[0.9] tracking-tight text-white md:text-[7vw] lg:text-[6vw]">
//                   {slides[activeStage].quote}
//                 </h2>

//                 <h2 className="font-[family-name:var(--font-cormorant)] text-[10vw] font-medium italic leading-[0.9] tracking-tight text-[#DCC9A8] md:text-[7vw] lg:text-[6vw]">
...
// const galleryCards = [
//   {
//     ...serviceApartmentImages[3],
//     aspect: "tall",
//     category: "Living",
//   },

//   {
//     ...serviceApartmentImages[6],
//     aspect: "wide",
//     category: "Architecture",
//   },

//   {
//     ...serviceApartmentImages[9],
//     aspect: "tall",
//     category: "Atmosphere",
//   },

//   {
//     ...serviceApartmentImages[1],
//     aspect: "wide",
//     category: "Interiors",
//   },

//   {
//     ...serviceApartmentImages[12],
//     aspect: "tall",
//     category: "Craft",
//   },

//   {
//     ...serviceApartmentImages[5],
//     aspect: "wide",
//     category: "Dining",
//   },

//   {
//     ...serviceApartmentImages[14],
//     aspect: "tall",
//     category: "Light",
//   },

//   {
//     ...serviceApartmentImages[10],
//     aspect: "wide",
//     category: "Detail",
//   },
// ];
...
//       style={{
//         height: `${galleryCards.length * 55}vh`,
//       }}
//     >
...
//           ref={trackRef}
//           style={{ x }}
//           className="flex will-change-transform gap-4 px-6 md:gap-6 md:px-16 lg:gap-8 lg:px-24"
//         >
...
//             <p className="text-center font-[family-name:var(--font-cormorant)] text-3xl italic leading-snug text-white/20 md:text-4xl">
//               Every space
//               <br />
//               tells a story.
//             </p>
...
//       }}
//       className={`
//         group relative flex-shrink-0 overflow-hidden rounded-sm bg-[#1A1A18]
//         ${
//           isTall
...
//   return (
//     <section className="relative z-10 bg-[#F4F1EB]">
//       {/* SECTION HEADER */}

//       <div className="px-6 pb-0 pt-24 md:px-16 lg:px-24">
...
//             className="font-[family-name:var(--font-cormorant)] text-5xl font-medium leading-[0.9] text-[#0E0E0E] md:text-7xl"
//           >
//             Work by{" "}
//             <span className="italic text-[#8C7A5E]">
//               Category
//             </span>
//           </motion.h2>
...
//                 className="group relative pb-4 pr-8 text-left"
//               >
//                 <span
...
//       <div className="px-6 pb-10 pt-8 md:px-16 lg:px-24">
...
//               className="max-w-md font-[family-name:var(--font-montserrat)] text-[11px] uppercase leading-loose tracking-[0.15em] text-[#0E0E0E]/50"
//             >
//               {category.description}
//             </motion.p>
//           </AnimatePresence>
...
// // ============================================================
// // CATEGORY IMAGE CARD
// // These remain clickable because they open the lightbox.
// // ============================================================
...
//       }}
//       onClick={onClick}
//       className="group relative mb-3 break-inside-avoid cursor-pointer overflow-hidden bg-[#E8E2D6] md:mb-4"
//       style={{
//         aspectRatio: isTall ? "3/4" : "4/3",
//       }}
//     >
//       <Image
//         src={img.src}
...
//       <div className="absolute left-3 top-3 font-[family-name:var(--font-montserrat)] text-[8px] font-semibold uppercase tracking-[0.3em] text-white/0 transition-colors duration-300 group-hover:text-white/60">
...
//           >
//             <path
//               d="M1 1h5M1 1v5M13 13h-5M13 13v-5M1 13l12-12"
//               stroke="white"
//               strokeWidth="1.2"
//               strokeLinecap="round"
//             />
...
//       <div className="absolute bottom-0 left-0 right-0 translate-y-1 p-3 opacity-0 transition-all duration-400 group-hover:translate-y-0 group-hover:opacity-100">
...
//       <button
//         onClick={onClose}
//         className="absolute right-6 top-6 flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white/60 transition-colors duration-200 hover:border-white/60 hover:text-white"
//       >
//         <svg
//           width="14"
//           height="14"
...
//             onPrev();
//           }}
//           className="absolute left-6 top-1/2 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 text-white/60 transition-colors duration-200 hover:border-white/60 hover:text-white"
//         >
//           <svg
//             width="16"
//             height="16"
...
//             onNext();
//           }}
//           className="absolute right-6 top-1/2 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 text-white/60 transition-colors duration-200 hover:border-white/60 hover:text-white"
//         >
//           <svg
//             width="16"
//             height="16"
...
//   return (
//     <section className="relative z-20 bg-[#DCC9A8] px-6 py-20 sm:px-10 md:px-16 md:py-32 lg:px-24">
...
//           }}
//         >
//           <p className="font-[family-name:var(--font-montserrat)] text-base leading-relaxed text-[#0E0E0E]/80 md:text-lg">
//             We strip away the unnecessary so the essential may
//             speak. Our designs are driven by an obsession with
//             context, a reverence for natural materials, and the
//             belief that the spaces we inhabit shape the lives we
//             lead.
//           </p>
//         </motion.div>
//       </div>
...
// function FooterCTA() {
//   return (
//     <section className="relative z-20 bg-[#0E0E0E] px-6 py-32 text-center sm:px-10 md:px-16 lg:px-24">
//       <motion.div
//         initial={{
//           opacity: 0,
//           scale: 0.95,
...
//         <h2 className="cursor-pointer font-[family-name:var(--font-cormorant)] text-6xl leading-none text-white transition-all duration-500 hover:italic md:text-8xl lg:text-9xl">
//           Let's Talk.
//         </h2>

//         {/* CONTACT PAGE LINK — KEEPING THIS BECAUSE IT IS AN ACTUAL PAGE */}

//         <a
//           href="/contact"
//           className="group relative mt-16 flex items-center gap-4 overflow-hidden rounded-full border border-white/20 px-8 py-4 transition-colors hover:border-[#DCC9A8]"
//         >
//           <span className="relative z-10 font-[family-name:var(--font-montserrat)] text-sm font-semibold tracking-widest text-white transition-colors duration-300 group-hover:text-[#0E0E0E]">
//             CONTACT STUDIO
//           </span>
