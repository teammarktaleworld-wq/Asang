      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <div className="absolute bottom-10 right-6 z-30 flex flex-col gap-2 md:right-10">
          {slides.map((_, i) => (
            <div
              key={i}
              className={`h-[1px] transition-all duration-500 ${i === activeStage ? "bg-[#DCC9A8] w-14" : "bg-white/20 w-8"
                }`}
            />
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 flex flex-wrap gap-0 border-b border-[#0E0E0E]/10">
            {portfolioCategories.map((cat, i) => (
              ...
              >
                <span
                  className={`font-[family-name:var(--font-montserrat)] text-[10px] font-semibold uppercase tracking-[0.3em] transition-colors duration-300 ${i === activeCategory
                      ? "text-[#0E0E0E]"
                ...
                <span
                  className={`ml-2 font-[family-name:var(--font-montserrat)] text-[9px] transition-colors duration-300 ${i === activeCategory ? "text-[#8C7A5E]" : "text-[#0E0E0E]/20"
                    }`}
                >
